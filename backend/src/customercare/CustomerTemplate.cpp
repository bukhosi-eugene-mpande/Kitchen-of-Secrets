...
CustomerTemplate::CustomerTemplate(std::shared_ptr<Engine> engine, std::string name, std::shared_ptr<PlayerInteraction> management) : GameComponent(engine) {
    this->name = name;
...
std::shared_ptr<PlayerInteraction> CustomerTemplate::getManagement() {
